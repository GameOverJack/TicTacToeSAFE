...
public interface TTTserver {
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "setIsFound", targetNamespace = "http://server.game.ttt/", className = "ttt.game.server.SetIsFound")
    @ResponseWrapper(localName = "setIsFoundResponse", targetNamespace = "http://server.game.ttt/", className = "ttt.game.server.SetIsFoundResponse")
    @Action(input = "http://server.game.ttt/TTTserver/setIsFoundRequest", output = "http://server.game.ttt/TTTserver/setIsFoundResponse")
    public void setIsFound(
        @WebParam(name = "uName", targetNamespace = "")
        String uName,
        @WebParam(name = "found", targetNamespace = "")
        int found);
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getPlayers", targetNamespace = "http://server.game.ttt/", className = "ttt.game.server.GetPlayers")
    @ResponseWrapper(localName = "getPlayersResponse", targetNamespace = "http://server.game.ttt/", className = "ttt.game.server.GetPlayersResponse")
    @Action(input = "http://server.game.ttt/TTTserver/getPlayersRequest", output = "http://server.game.ttt/TTTserver/getPlayersResponse")
