...
public interface TicTacToeServer {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getPlayers", targetNamespace = "http://game.server.ttt/", className = "ttt.server.game.GetPlayers")
    @ResponseWrapper(localName = "getPlayersResponse", targetNamespace = "http://game.server.ttt/", className = "ttt.server.game.GetPlayersResponse")
    @Action(input = "http://game.server.ttt/TicTacToeServer/getPlayersRequest", output = "http://game.server.ttt/TicTacToeServer/getPlayersResponse")
