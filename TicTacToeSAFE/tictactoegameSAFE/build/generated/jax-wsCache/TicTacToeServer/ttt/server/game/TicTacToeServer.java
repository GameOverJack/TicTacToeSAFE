...
public interface TicTacToeServer {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getPlayer", targetNamespace = "http://game.server.ttt/", className = "ttt.server.game.GetPlayer")
    @ResponseWrapper(localName = "getPlayerResponse", targetNamespace = "http://game.server.ttt/", className = "ttt.server.game.GetPlayerResponse")
    @Action(input = "http://game.server.ttt/TicTacToeServer/getPlayerRequest", output = "http://game.server.ttt/TicTacToeServer/getPlayerResponse")
